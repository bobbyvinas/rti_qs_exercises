...
class ShapeTypeExtendedListener : public DataReaderListener {
  public:
    ...
    virtual void on_requested_incompatible_qos(
        ...
        const RequestedIncompatibleQosStatus& status) {
          printf("on_requested_incompatible_qos triggered. status.last_policy_id = %d\n", status.last_policy_id);
        }
...
void ShapeTypeExtendedListener::on_data_available(DataReader* reader)
{
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    reader = subscriber->create_datareader_with_profile(
        topic, SHAPETYPE_LIBRARY, SHAPETYPE_PROFILE, reader_listener,
        STATUS_MASK_ALL);
    if (reader == NULL) {
